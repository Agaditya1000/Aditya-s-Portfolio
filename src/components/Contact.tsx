              ...
              <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8">
                ...
                <div className="flex space-x-4">
                  <a 
                    ...
                    className="w-10 h-10 rounded-full bg-[#0A66C2] flex items-center justify-center text-white transform hover:scale-110 transition-transform duration-300"
                    aria-label="LinkedIn"
                  >
                  ...
                  <a 
                    ...
                    target="_blank" 
                    rel="noopener noreferrer" 
                    className="w-10 h-10 rounded-full bg-gray-800 dark:bg-gray-700 flex items-center justify-center text-white transform hover:scale-110 transition-transform duration-300"
                    aria-label="GitHub"
                  >
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <a 
                    ...
                    target="_blank" 
                    rel="noopener noreferrer" 
                    className="w-10 h-10 rounded-full bg-[#2EC866] flex items-center justify-center text-white transform hover:scale-110 transition-transform duration-300"
                    aria-label="HackerRank"
                  >
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M12 0c-6.627 0-12 5.373-12 12s5.373 12 12 12 12-5.373 12-12-5.373-12-12-12zm0 4.551l4.451 4.451v6h-4.451v-4.451h-4.451v4.451h-4.451v-6l4.451-4.451h4.451zm-2.992 4.866h-3.008v5.134h3v-5.134zm6 0h-3.008v5.134h3v-5.134z"/>
                    </svg>
                  </a>
                </div>
              </div>
              ...
              <form onSubmit={handleSubmit}>
                ...
                <button 
                  ...
                  className={`w-full px-6 py-3 ${
                    isSubmitting ? 'bg-gray-500' : 'bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700'
                  } text-white font-medium rounded-lg transition-all shadow-md hover:shadow-lg flex items-center justify-center`}
                >
                  {isSubmitting ? (
                    <>
